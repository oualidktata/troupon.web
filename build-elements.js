...
(async function build() {
  ...
  if (prgName === '' || prgName === undefined) {
    ...
    const files_es5 = [
      './dist/' + prgName + '/runtime.js',
      './dist/' + prgName + '/polyfills.js',
      //'./dist/' + prgName + '/scripts.js',
      './dist/' + prgName + '/main.js',
    ]
    await fs.ensureDir('./dist/' + prgName + '/elements');
    //await fs.copyFile('./dist/' + prgName + '/styles.css', 'elements/' + prgName + '-styles.css')
    await concat(files_es5, './dist/' + prgName + '/elements/' + prgName + '-elements.js');
